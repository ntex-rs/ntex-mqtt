...
pub enum MqttError<E> {
    ...
    /// Mqtt parse error
    Protocol2(crate::codec3::EncodeError),
    /// Unexpected packet
...
impl<E> From<crate::codec3::EncodeError> for MqttError<E> {
    fn from(err: crate::codec3::EncodeError) -> Self {
        MqttError::Protocol2(err)
    }
}
