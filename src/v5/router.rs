...
type Handler<AppSt, E> =
    BoxServiceFactory<Session<AppSt>, Publish, PublishAck, E, Connection<AppSt>, Box<dyn Error>>;
    ...
    Err: 'static,
{
    ...
    pub fn new<U>(
        default: impl IntoServiceFactory<U, Session<AppSt>, Publish, Connection<AppSt>>,
    ) -> Self
    where
        U: ServiceFactory<
                Session<AppSt>,
