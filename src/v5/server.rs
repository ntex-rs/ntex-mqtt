    ...
    P::InitError: Error,
{
    ...
    pub fn connect<H, St>(
        self,
        handshake: impl IntoService<H, St, Handshake<Im>>,
    ) -> service::MqttServer<
        St,
        Im,
        AppSt,
    ...
    >
    where
        H: Service<St, Handshake<Im>, Res = HandshakeAck<AppSt>, Error = Err> + 'static,
        St: 'static,
    {
        let handshake = HandshakePipeline::new(HandshakeService::<Im, AppSt, _> {
