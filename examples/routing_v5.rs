...
use ntex::service::{fn_factory, fn_factory_with_config, fn_service};
use ntex_mqtt::v5;
...
async fn main() -> std::io::Result<()> {
    ...
    ntex::server::build()
        .bind("mqtt", "127.0.0.1:1883", async |_| {
            v5::MqttServer::new(fn_factory(|| async {
                Ok::<_, ServerError>(fn_service(|handshake: v5::Handshake| async move {
            ...
            .publish(
                ...
                v5::Router::new(fn_factory(|| async {
